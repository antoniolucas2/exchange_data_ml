...
class ModelExchangeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendWeights = channel.unary_unary(
                '/ModelExchange/SendWeights',
                request_serializer=model__pb2.ModelWeights.SerializeToString,
...
def add_ModelExchangeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendWeights': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=model__pb2.ModelWeights.FromString,
    ...
    server.add_registered_method_handlers('ModelExchange', rpc_method_handlers)
...
class ModelExchange(object):
    ...
    def SendWeights(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ModelExchange/SendWeights',
            model__pb2.ModelWeights.SerializeToString,
