...
# FIX: Plural 'models'
model_a = tf.keras.models.load_model('nids_sensor_A_versao_2.keras')
model_b = tf.keras.models.load_model('nids_sensor_B_versao_2.keras')
...
class ModelBService(collaboration_pb2_grpc.NidsCollaborationServicer):
    ...
    def RequestPrediction(self, request, context):
        ...
        return collaboration_pb2.PredictionBatch(
            ...
            confidences=confidences.tolist() # Enviando a certeza pela rede!
        )
def serve_model_b():
...
print("Salvando dataset original de teste (A) em disco...")
original_data_dict = {
    'X_test_A': X_test_A,
    'y_test_A': y_test_A
}
with open('dados_originais_teste_A.pkl', 'wb') as f:
